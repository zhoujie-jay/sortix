/*******************************************************************************
    ...
    sortix/x64/bits.h
    Declares the required datatypes for the x64 architecture.

*******************************************************************************/

#ifndef INCLUDE_SORTIX_X64_BITS_H
#define INCLUDE_SORTIX_X64_BITS_H
...
#define __LONG_MIN __INT64_MIN
#define __LONG_MAX __INT64_MAX
#define __ULONG_MAX __UINT64_MAX
...
#define __SIZE_MAX __ULONG_MAX
#define __INTPTR_MIN __LONG_MIN
#define __INTPTR_MAX __LONG_MAX
#define __UINTPTR_MAX __ULONG_MAX
